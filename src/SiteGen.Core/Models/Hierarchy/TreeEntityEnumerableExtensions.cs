...
public static class TreeEntityEnumerableExtensions
{
    ...
    /// <returns></returns>
    public static IEnumerable<TEntity> Siblings<TEntity>(this IEnumerable<TEntity> entities, TEntity entity, TreeListOptions options = TreeListOptions.ExcludeSelf) where TEntity : class, ITreeEntity<TEntity>, IEntity
    {
    ...
    /// <returns></returns>
    public static IEnumerable<TEntity> Ancestors<TEntity>(this IEnumerable<TEntity> entities, TEntity entity, TreeListOptions options = TreeListOptions.ExcludeSelf) where TEntity : class, ITreeEntity<TEntity>, IEntity
    {
        VerifyTreeNode(entity);
        var results = entities.Where(node => node.Tree.LeftValue < entity.Tree.LeftValue && node.Tree.RightValue > entity.Tree.RightValue);

        if (options == TreeListOptions.IncludeSelf) results = results.Concat(new []{entity});
    ...
    /// <param name="entities">The entities.</param>
    /// <returns></returns>
    public static IEnumerable<TEntity> Ancestors<TEntity>(this IEnumerable<TEntity> entities) where TEntity : class, ITreeEntity<TEntity>, IEntity
    {
        return entities.SelectMany(entity => Ancestors<TEntity>(entities, entity, TreeListOptions.IncludeSelf)).Distinct();
    }
    ...
    /// <returns></returns>
    public static IEnumerable<TEntity> Children<TEntity>(this IEnumerable<TEntity> entities, TEntity entity) where TEntity : class, ITreeEntity<TEntity>, IEntity
    {
    ...
    /// <returns></returns>
    public static IEnumerable<TEntity> Descendants<TEntity>(this IEnumerable<TEntity> entities, TEntity entity) where TEntity : class, ITreeEntity<TEntity>, IEntity
    {
        VerifyTreeNode(entity);
    ...
    static void VerifyTreeNode<TEntity>(ITreeEntity<TEntity> entity, bool allowNull = false) where TEntity : class, ITreeEntity<TEntity>, IEntity
    {
